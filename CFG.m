...
[blockNumber,~] = size(allBaseBlock);
cfgRelation1 = zeros(1,blockNumber);
cfgRelation1(1,1) = 1;

tmp_cfgRelationRow = 2;
cfgRelation1 = [cfgRelation1;zeros(1,blockNumber)];
...
cfgRelation2 = zeros(relationRow,1);%设置等式右边的矩阵
cfgRelation2(1) = 1;
