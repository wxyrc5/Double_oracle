...
ATTACKER_CAPACITY  = baseBlockNumber/8;  %defender最多能插入的bug数
...
pureSetAttacker(1,1:baseBlockNumber) = bestResponseAttacker;

%设置defender的初始策略
bestResponseDefender = zeros(1,baseBlockNumber);
bestResponseDefender(10:10+ATTACKER_CAPACITY-1) = 0.9;%或者任意设置defender的初始策略
pureSetDefender(1,1:baseBlockNumber) = bestResponseDefender;
